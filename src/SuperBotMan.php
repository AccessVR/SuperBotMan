 ...
 * @method int|string|null agentUserId()
 ...
 * @method string widget(array $overrides = [])
 * @method array|null embedContext(string $key)
 * @method array frameOverrides(\Illuminate\Http\Request $request)
 * @method array getEmbedLoaderConfig(string $key)
